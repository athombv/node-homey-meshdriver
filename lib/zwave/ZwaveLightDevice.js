...
/**
 * The ZwaveLightDevice class has built-in functionality for the debounced light capabilities
 * first create a list of groupedCapabilities, then call this._registerGroupedCapabilities(groupedCapabilities)
 *
 ...
 * 			});
 * 		}
 * 		this._registerGroupedCapabilities(groupedCapabilities);
 * 	}
 * }
 */
...
class ZwaveLightDevice extends ZwaveDevice {
	 ...
	 * @private
	 */
	_registerGroupedCapabilities(groupedCapabilities) {
