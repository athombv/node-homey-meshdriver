...
class ZwaveDevice extends MeshDevice {
   ...
   * @returns {Promise<unknown>}
	...
	printNode() {
		...
		if (Object.prototype.hasOwnProperty.call(this.node, 'manufacturerId') && 
			Object.prototype.hasOwnProperty.call(this.node.manufacturerId, 'value')) {
			this.log('- Manufacturer id:', this.node.manufacturerId.value);
		}
		if (Object.prototype.hasOwnProperty.call(this.node, 'productTypeId') &&
			Object.prototype.hasOwnProperty.call(this.node.productTypeId, 'value')) {
			this.log('- ProductType id:', this.node.productTypeId.value);
		}
		if (Object.prototype.hasOwnProperty.call(this.node, 'productId') &&
			Object.prototype.hasOwnProperty.call(this.node.productId, 'value')) {
			this.log('- Product id:', this.node.productId.value);
		}
		if (Object.prototype.hasOwnProperty.call(this.getSettings(), 'zw_application_version') &&
			Object.prototype.hasOwnProperty.call(this.getSettings(), 'zw_application_sub_version')) {
			this.log('- Firmware Version:', `${this.getSetting('zw_application_version')}.${this.getSetting('zw_application_sub_version')}`);
		}
		if (Object.prototype.hasOwnProperty.call(this.getSettings(), 'zw_hardware_version')) {
			this.log('- Hardware Version:', this.getSetting('zw_hardware_version'));
		}
		if (Object.prototype.hasOwnProperty.call(this.node, 'firmwareId')) {
		...
		if (Object.prototype.hasOwnProperty.call(this.getSettings(), 'zw_secure')) {
